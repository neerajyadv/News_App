...
public class ScienceActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<News>> {

    private CustomRecycle customRecycle;
    private RecyclerView recyclerView;
    private String URL_GET_DATA="https://newsapi.org/v2/top-headlines?sources=new-scientist&apiKey=905fbda7f3944db1b3e9acaac4b51018";
